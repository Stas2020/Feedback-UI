...
function RefreshSanPin() {
    ...
    $("#grid_sanpin").css("display", "none");
    $("#grid_sanpin").parent().append('<img id="wait_sanPin" style="width: 10%; margin-top:50px;margin-left:45%; margin-right:45%" src="https://s2010/feedback/wait5.gif" />');
...
function getSanPinDetails(depId) {
    ...
    try {
        ...
        $.ajax({
            url: "https://s2010/complaints/api/info/GetSanPinDetails?FStartDate=" + FStartDate + "&FEndDate=" + FEndDate + "&DepId=" + String(depId),
            global: false,
            type: "GET",
            success: function (data) {
                if (typeof (data) == "object") {
...
function BarcodSelectNaumen() {
    $.ajax({
        url: "https://s2010/complaints/api/info/GetBarcodesFromNaumen",
        global: false,
        type: "GET",
        success: function (data) {
            ...
            if (typeof (data) == "object") {
                ...
                $("#grid_naumen_dishes").kendoGrid({
                    columns: [{ field: "Barcode", title: "Баркод", width: barWidth }, { field: "Name", title: "Название" }],
                    selectable: "row",
                    height: isMobile ? "100%" : 630,
                    resizable: false,
...
function BarcodSelectMenu() {
    $.ajax({
        url: "https://s2010/complaints/api/info/GetBarcodesFromMenu",
        global: false,
        type: "GET",
        success: function (data) {
            var tttt = typeof (data);
...
function DocNumChanged() {
    ...
    if (Data.CheckList.DocNumMode == 2) {
        $.ajax({
            url: "https://s2010/complaints/api/info/GetBarcodeName?CodGood=" + String(barcode),
            global: false,
            type: "GET",
            success: function (data) {
...
function ShopPaharLog(operWindow) {
    $.ajax({
        url: "https://s2010/complaints/api/info/GetPaharLog",
        global: false,
        type: "GET",
        success: function (data) {
            var tttt = typeof (data);
...
function PahRecalcPahar() {
    ...
    if (pwd != null && pwd != "") {
        $.ajax({
            url: "https://s2010/complaints/api/info/RecalcPahar?FStartDate=" + day + "&FEndDate=" + day,
            global: false,
            type: "POST",
            contentType: "application/json",
...
function PahLogResetState() {
    ...
    if (pwd != null && pwd != "") {
        $.ajax({
            url: "https://s2010/complaints/api/info/ResetPaharLogStates",
            global: false,
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify(pwd),
...
function RefreshStaffTurnover() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetStaffTurnover?" + filtersGet,
        global: false,
        type: "GET",
        success: function (data) {
...
function RefreshStaffVacation() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetStaffEmployeeVacations" + filtersGet,
        global: false,
        type: "GET",
        success: function (data) {
...
function RefreshStaffing() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetStaffingTable",
        global: false,
        type: "GET",
        success: function (data) {
        ...
        cellClose: function (e) {
            ...
            if (e.model[col] != grid_prev_val) {
                ...
                if (cancel) {
                    ...
                    $.ajax({
                        url: "https://s2010/complaints/api/info/PostStaffingTableValue",
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify(send_data),
                        success: function (data) {
