...
function getCustomNames() {
    $.ajax({
        url: "https://s2010/complaints/api/info/GetReferenceCustomNames",
        global: false,
        type: "GET",
        success: function (data) {
            var tttt = typeof (data);
...
function getReportManualTypes() {
    $.ajax({
        url: "https://s2010/complaints/api/info/GetReportsTypes?OnlyManual=true",
        global: false,
        type: "GET",
        success: function (data) {
            var tttt = typeof (data);
...
function RefreshDishKoefs() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetDishCoefficients",
        global: false,
        type: "GET",
        success: function (data) {
...
function RefreshWriteoffRefers() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetReferenceValues?" + filtersGet,
        type: "POST",
...
function UpdateDishBottles() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/UpdateDishBottles",
        global: false,
        type: "GET",
        success: function (data) {
            WaitHide("dish_koefs", null);
...
function DelPahRef() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/DeleteReferenceValue",
        type: "POST",
        contentType: "application/json",
        data: JSON.stringify(send_data),
        success: function (data) {
...
function onPahRefSave() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/PostReferenceValue",
        type: "POST",
        contentType: "application/json",
        data: JSON.stringify(send_data),
        success: function (data) {
...
function RefreshOuterRefers() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetOuterReferences?FDate=" + FDate + "&ReportId=" + String(rep),
        global: false,
        type: "GET",
        success: function (data) {
...
function RefreshRestWorkTime() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetRestWorkingTimes",
        global: false,
        type: "GET",
        success: function (data) {
        ...
        cellClose: function (e) {
            if (e.model.Value != grid_prev_val) {
                ...
                if (cancel) {
                    ...
                    $.ajax({
                        url: "https://s2010/complaints/api/info/PostOuterReference",
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify(send_data),
                        success: function (data) {
        ...
        cellClose: function (e) {
            ...
            if (e.model[col] != grid_prev_val) {
                ...
                if (cancel) {
                    ...
                    $.ajax({
                        url: "https://s2010/complaints/api/info/PostRestWorkingTimeParam?Param=" + col,
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify(send_data),
                        success: function (data) {
...
function RefreshStaffDecret() {
    ...
    $.ajax({
        url: "https://s2010/complaints/api/info/GetStaffDecretEmployees",
        global: false,
        type: "GET",
        success: function (data) {
